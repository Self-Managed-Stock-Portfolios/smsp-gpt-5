...
def fetch_stock_data(date_input: str) -> pd.DataFrame:
    ...
    mid_symbols = [
        ...
        'MANKIND.NS', 'WAAREEENER.NS', 'UNIONBANK.NS', 'INDUSTOWER.NS', 'MARICO.NS', 'INDIANB.NS', 'BSE.NS',
    ...
    small_symbols = [
        ...
        'LALPATHLAB.NS', 'PPLPHARMA.NS', 'JBCHEPHARM.NS', 'PEL.NS', 'FSL.NS', 'INOXWIND.NS', 'TATACHEM.NS',
