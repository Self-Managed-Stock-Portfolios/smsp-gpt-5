...
def fetch_stock_data(date_input: str) -> pd.DataFrame:
    ...
    mid_symbols = [
        'ADANIENT.NS', 'APOLLOHOSP.NS', 'VBL.NS', 'PERSISTENT.NS', 'ABB.NS', 'SUZLON.NS', 'AUBANK.NS', 'GODREJCP.NS',
        ...
        'JUBLFOOD.NS', 'SYNGENE.NS', 'ZYDUSLIFE.NS', 'ALKEM.NS', 'HDFCAMC.NS', 'MAZDOCK.NS', 'MAXHEALTH.NS', 'POLYCAB.NS',
    ...
    small_symbols = [
        'IDBI.NS', 'IOB.NS', 'FACT.NS', 'GODFRYPHLP.NS', 'AIIL.NS', 'LAURUSLABS.NS', 'MCX.NS', 'RADICO.NS', 'UCOBANK.NS',
        'SUVEN.NS', 'CHOLAHLDNG.NS', 'NH.NS', 'POONAWALLA.NS', 'DELHIVERY.NS', 'CENTRALBK.NS', 'CDSL.NS', 'GODIGIT.NS',
        'ASTERDM.NS', 'ITI.NS', 'AFFLE.NS', 'GRSE.NS', 'KIMS.NS', 'NBCC.NS', 'SUMICHEM.NS', 'AEGISLOG.NS', 'HINDCOPPER.NS',
