...
def fetch_stock_data(date_input: str) -> pd.DataFrame:
    ...
    small_symbols = [
        'IDBI.NS', 'IOB.NS', 'GODFRYPHLP.NS', 'KAYNES.NS', 'LAURUSLABS.NS', 'MCX.NS', 'RADICO.NS', 'UCOBANK.NS',
        'SUVEN.NS', 'NH.NS', 'POONAWALLA.NS', 'DELHIVERY.NS', 'CENTRALBK.NS', 'CDSL.NS', 
        'ASTERDM.NS', 'ITI.NS', 'GRSE.NS', 'KIMS.NS', 'NBCC.NS', 'AEGISLOG.NS', 'AMBER.NS', 'HINDCOPPER.NS',
        'LALPATHLAB.NS', 'PPLPHARMA.NS', 'JBCHEPHARM.NS', 'FSL.NS', 'INOXWIND.NS', 'TATACHEM.NS',
        'SHYAMMETL.NS', 'NAVINFLUOR.NS', 'EIHOTEL.NS', 'WOCKPHARMA.NS', 'RAMCOCEM.NS', 'MANAPPURAM.NS',
        'IRCON.NS', 'BEML.NS', 'IRCTC.NS', 'HUDCO.NS', 'HAL.NS', 'SAIL.NS', 'BEL.NS',
        'COFORGE.NS', 'KPIGREEN.NS', 'CROMPTON.NS', 'THERMAX.NS', 'ASTRAL.NS', 'SJVN.NS', 'IRB.NS', 'RBLBANK.NS',
        'INDIAMART.NS', 'DEEPAKNTR.NS', 'CREDITACC.NS', 'NAVA.NS', 'KEI.NS', 'OBEROIRLTY.NS',
    ]
